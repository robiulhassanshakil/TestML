...
namespace TestML
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\User\Downloads\electricityusageClient339.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:46,seriesLength:190,trainSize:2159,horizon:24,outputColumnName:@"energy_use",inputColumnName:@"energy_use",confidenceLowerBoundColumn:@"energy_use_LB",confidenceUpperBoundColumn:@"energy_use_UB");
