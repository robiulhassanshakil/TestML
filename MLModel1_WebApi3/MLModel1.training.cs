...
using Microsoft.ML;
    public partial class MLModel1
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:766,seriesLength:2309,trainSize:1048575,horizon:10,outputColumnName:@"CarbonEmission",inputColumnName:@"CarbonEmission",confidenceLowerBoundColumn:@"CarbonEmission_LB",confidenceUpperBoundColumn:@"CarbonEmission_UB");
