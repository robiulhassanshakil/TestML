...
namespace ManualModelTrain
{
    ...
    {
        public const string RetrainFilePath =  @"D:\Office Code\SJ\Microsoft_ML_DotNet\TestML\ManualModelTrain\Data\electricityusageClient339.csv";
        public const string RetrainFilePathTest = @"D:\Office Code\SJ\Microsoft_ML_DotNet\TestML\ManualModelTrain\Data\electricityusageClient339_TestLastMonthData.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:24, seriesLength:2159, trainSize:2159, confidenceLevel: 0.95f, horizon:10,outputColumnName:@"energy_use",inputColumnName:@"energy_use",confidenceLowerBoundColumn:@"energy_use_LB",confidenceUpperBoundColumn:@"energy_use_UB");
